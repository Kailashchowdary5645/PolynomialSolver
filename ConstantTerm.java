...
/**
 * Compile: javac ConstantTerm.java
 * Run:     java ConstantTerm < input.json
...
public class ConstantTerm {
  ...
  // Very small JSON reader for the given structure
  ...
  static Parsed parse(String json) {
    ...
    while (true){
      ...
      BigInteger y = new BigInteger(vStr, base); // supports up to radix 36
      pts.add(new Pt(x, y));
    }
